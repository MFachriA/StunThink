    ...
    StunThinkTheme {
        ...
        LaunchedEffect(key1 = context) {
            child?.let {
                ...
                viewModel.onEvent(EditChildFormEvent.NameChanged(child.namaLengkap))
                viewModel.onEvent(EditChildFormEvent.GenderChanged(child.jenisKelamin))
                viewModel.onEvent(EditChildFormEvent.DateChanged(child.tanggalLahir))
                viewModel.onEvent(EditChildFormEvent.AddressChanged(child.tempatLahir))
            }
...
private fun Content(
    ...
    Column(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(EditChildFormEvent.NameChanged(it))
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        RadioButton(
                            ...
                            onClick = {
                                ...
                                viewModel.onEvent(
                                    EditChildFormEvent.GenderChanged(text)
                                )
                            }
                        )
                        Text(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(EditChildFormEvent.DateChanged(it))
                    _isFieldChanged = true
                },
                modifier = Modifier
                    .fillMaxWidth()
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(EditChildFormEvent.AddressChanged(it))
                    _isFieldChanged = true
                },
                modifier = Modifier.fillMaxWidth(),
            ...
            Button(
                onClick = { viewModel.onEvent(EditChildFormEvent.Submit) },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(top = 8.dp),
    ...
    CalendarDialog(
        ...
        selection = CalendarSelection.Date { date ->
            viewModel.onEvent(EditChildFormEvent.DateChanged(date.toString()))
            _isFieldChanged = true
